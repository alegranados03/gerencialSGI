        ...
        <div class="card-body">
          <div class="row" style="color: black">
            <div class="col-md-12" style="text-align: center;">
              ...
              <div class="tooltip-demo">
                  <button title="Esta pantalla muestra los ingresos por ventas hechos en el sitio de Tienda en Línea, 
                  ...
                  especificar cuantas separaciones de los datos necesita, la cantidad mínima es de 2 intervalos
                   y el campo 'Rango entre intervalos en $'
          ...
          <div class="float-md-right">
            <table class="table table-responsive">
              <tr>
                <td class="border-0">
                  <form id="form2" method="POST" action="{{route('reporteP3T')}}">
                    @csrf
...
@section('scriptDataTable')
  ...
  <script type="text/javascript" src="{{ asset('js/ajaxRequestProducto_P3T.js')}}"></script> <!-- script generador de tabla-->
