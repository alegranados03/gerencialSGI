        ...
        <div class="card-body">
          <div class="row" style="color: black">
            <div class="col-md-12" style="text-align: center;">
              ...
              <h5 id="titulo">Reporte de costos de adquisición de materia prima.</h5>
              <div class="tooltip-demo">
                  <button title="Esta pantalla muestra los costos de adquisición agrupados por materia prima,
                  coloque el rango de fechas para poder generar la información que necesita sobre el periodo especificado. " 
          ...
          <div class="float-md-right">
            <table class="table table-responsive">
              <tr>
                <td class="border-0">
                  <form id="form2" method="POST" action="{{route('reporteP5T')}}">
                    @csrf
...
@section('scriptDataTable')
  ...
  <script type="text/javascript" src="{{ asset('js/ajaxRequestMateria_Prima_P5T.js')}}"></script> <!-- script generador de tabla-->
