        ...
        <div class="card-body">
          <div class="row" style="color: black">
            <div class="col-md-12" style="text-align: center;">
              ...
              <h5 id="titulo">Reporte de Preferencia de pago de los clientes.</h5>
              <div class="tooltip-demo">
                  <button title="Esta pantalla muestra las preferencias de pago que tienen los clientes de la panadería,
                  ya sea En Línea o en el establecimiento.
            ...
            <table class="table table-responsive">
              <tr>
                <td class="border-top-0">
                  <form id="form2" method="POST" action="{{route('reporteP4E')}}">
                    @csrf
...
@section('scriptDataTable')
  ...
  <script type="text/javascript" src="{{ asset('js/ajaxRequestClientes_P4E.js')}}"></script> <!-- script generador de tabla-->
