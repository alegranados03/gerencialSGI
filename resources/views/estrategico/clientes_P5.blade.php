        ...
        <div class="card-body">
          <div class="row" style="color: black">
            <div class="col-md-12" style="text-align: center;">
              ...
              <h5 id="titulo">Reporte de ventas realizadas en la tienda en línea agrupados por género.</h5>
              <div class="tooltip-demo">
                  <button title="Esta pantalla muestra los ingresos de ventas realizadas en la tienda en línea,
...
@section('scriptDataTable')
  ...
  <script type="text/javascript" src="{{ asset('js/ajaxRequestClientes_P5E.js')}}"></script> <!-- script generador de tabla-->
@endsection