        ...
        <div class="card-body">
          <div class="row" style="color: black">
            <div class="col-md-12" style="text-align: center;">
              ...
              <h5 id="titulo">Reporte de ganancia bruta por categoria.</h5>
              <div class="tooltip-demo">
                  <button title="Esta pantalla muestra las ganancias brutas agrupadas por categoría. 
...
@section('scriptDataTable')
  ...
  <script type="text/javascript" src="{{ asset('js/ajaxRequestProducto_P2E.js')}}"></script> <!-- script generador de tabla-->
@endsection