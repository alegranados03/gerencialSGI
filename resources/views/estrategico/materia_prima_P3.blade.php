        ...
        <div class="card-body">
          <div class="row" style="color: black">
            <div class="col-md-12" style="text-align: center;">
              ...
              <h5 id="titulo">Reporte de Costos de Materia Prima por Proveedor.</h5>
              <div class="tooltip-demo">
                  <button title="Esta pantalla muestra los costos de adquisición de materia prima agrupados por proveedor.
              ...
              <div class="table-responsive">
                <table id="reporte" class="table table-responsive table-hover table-striped table-condensed" width="100%" style="display: none;">
                  <thead id="theHeader" class="thead-dark">
                    ...
                    <th>Total de Costos(En dólares)</th>
                  </thead>
            ...
            <table class="table table-responsive">
              <tr>
                <td class="border-top-0">
                  <form id="form2" method="POST" action="{{route('reporteP3E')}}">
                    @csrf
...
@section('scriptDataTable')
  ...
  <script type="text/javascript" src="{{ asset('js/ajaxRequestMateria_Prima_P3E.js')}}"></script> <!-- script generador de tabla-->
