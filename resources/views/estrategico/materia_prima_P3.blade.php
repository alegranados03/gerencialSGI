        ...
        <div class="card-body">
          <div class="row" style="color: black">
            <div class="col-md-12" style="text-align: center;">
              ...
              <h5>Reporte de Costos de Materia Prima por Proveedor.</h5>
            </div>
          </div>
        ...
        if($("#fechaInicio").val() != "" && $("#fechaFin").val() != "" ){
          if(fechaInicio <= fechaFin){
            if(fechaFin < hoy){
              ...
              $("#mensaje3").hide();
              $.ajax({
                url:"{{URL::to('ajaxRequestMateria_Prima_P3E')}}",
                type:"GET",
                data: datos,
                success: function(data){
                  ...
                  if(data ==""){
                    ...
                    $("#reporte-info").empty();
                        ...
                        $("#btnPDF").attr('href','/ReportePDF_P3E/'+JSON.stringify(datosExcel)+"/"+fecha1+"/"+fecha2);
